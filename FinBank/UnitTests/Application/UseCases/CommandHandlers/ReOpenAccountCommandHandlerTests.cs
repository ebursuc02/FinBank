...
namespace UnitTests.Application.UseCases.CommandHandlers
{
    ...
    public class ReOpenAccountCommandHandlerTests
    {
        ...
        public async Task HandleAsync_ShouldReOpenAccount_ForValidRequest()
        {
            ...
            var command = new ReOpenAccountCommand { AccountIban = "iban1", CustomerId = customerId };
        ...
        public async Task HandleAsync_ShouldReturnNotFound_WhenAccountDoesNotExistOrNotBelongToCustomer()
        {
            ...
            var command = new ReOpenAccountCommand { AccountIban = "iban2", CustomerId = customerId };
        ...
        public async Task HandleAsync_ShouldReturnConflict_WhenAccountAlreadyOpen()
        {
            ...
            var command = new ReOpenAccountCommand { AccountIban = "iban3", CustomerId = customerId };
        ...
        public void HandleAsync_ShouldThrow_WhenRepositoryThrows()
        {
            // Arrange
            var customerId = Guid.NewGuid();
            var command = new ReOpenAccountCommand { AccountIban = "iban4", CustomerId = customerId };
