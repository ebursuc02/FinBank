...
public class RiskEvaluationBehaviorTests
{
    ...
    public async Task Should_SetRiskContext_ForSuccessfulRiskFetch()
    {
        ...
        _riskClient.GetAsync(customerId, Arg.Any<CancellationToken>()).Returns(Result.Ok(RiskStatus.High));
    ...
    public async Task Should_SetMediumRisk_IfRiskFetchFails()
    {
        ...
        _riskClient.GetAsync(customerId, Arg.Any<CancellationToken>()).Returns(Result.Fail("fail"));
    ...
    public void Should_PropagateExceptions_FromDependencies()
    {
        ...
        _riskClient.GetAsync(customerId, Arg.Any<CancellationToken>()).Throws(new Exception("kyc error"));
