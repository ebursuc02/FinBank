...
{
    public async Task<Transfer?> GetAsync(Guid transferId, CancellationToken ct = default)
    ...
    public async Task<IReadOnlyList<Transfer>> GetForAccountAsync(string iban, int take, CancellationToken ct = default)
